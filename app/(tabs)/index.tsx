...
export default function App() {
  return ( // safeareview component prevents contents from getting cut in curved edges screens
    <SafeAreaView className=" flex-1 bg-white">



      {/* to render list, we use flatlist in react-native , instead of map */}
      <FlatList
        data={offers}
        renderItem={({ item, index }) => {
          const isEven = (index % 2 === 0);
          return (<View>
            {/* to make thing clickable we use Pressable component */}
